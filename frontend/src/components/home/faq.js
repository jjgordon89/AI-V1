...
const Appfaq = () => {
    // Assuming 'block', 'container-fluid', and 'titleHolder' are global classes from App.css
    return (
        <div className={`block ${styles.faqBlock}`} style={{display:'flex'}}> {/* Applied styles.faqBlock */}
          <div className="container-fluid">
            ...
            <div className={styles.quickSupport}> {/* Applied styles.quickSupport */}
              <h2>Need more help </h2>
              <Button type="primary"><i size="large" className="fas fa-envelope"></i> Write us</Button> {/* Changed class to className for JSX */}
            </div>
          </div>            
        </div>
    );
